...
S.background = [0.5 0.5 0.5].^(1/2.2);
...
S.chBeam4 = 8;                      % ADC channel for IR Beam 4 (midway down box)
...
% Stimulus settings
% CPD SHOULD ONLY BE MULTIPLE OF 0.125, e.g. 0.125, .25, .5, 1, 2 ,4
P.cpd = .25;
...
P.durStim = -1;
S.durStim = 'Duration of stimulus (s):';
...
% Column 3: Grating angle -- Column 4: Luminance +/- (contrast)
...
% %%%%Trial list 1:2 (1 right trial for 2 left)
% 1   0.125   0   3;
% 2   0.125   0   3;
% 2   0.125   0   3;
% 1   0.125   0   10;
...
% %%%%Trial list 2:1 (2 right trial for 1 left)
% 1   0.125   0   3;
% 1   0.125   0   3;
% 2   0.125   0   3;
% 1   0.125   0   10;
