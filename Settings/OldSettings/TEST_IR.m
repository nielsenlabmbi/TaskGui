...
% Timing variables
P.durValve1 = 120;                                       % Reward duration for valve 1 (ms)
S.durValve1 = 'Duration of right valve (ms):';
P.durValve2 = 120;                                       % Reward duration for valve 2 (ms)
S.durValve2 = 'Duration of left valve (ms):';
P.durValve3 = 30;                                       % Reward duration for valve 3 (ms)
S.durValve3 = 'Duration of back valve (ms):';
P.durTone = 1;                                          % audio feedback (s)
S.durTone = 'Duration of feedback tone (s):';
P.durTimeOut = 1;                                       % time out if not on first try
