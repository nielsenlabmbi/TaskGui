function varargout = TaskGui2(varargin)
% TASKGUI2 MATLAB code for TaskGui2.fig
%      TASKGUI2, by itself, creates a new TASKGUI2 or raises the existing
%      singleton*.
%
%      H = TASKGUI2 returns the handle to a new TASKGUI2 or the handle to
%      the existing singleton*.
%
%      TASKGUI2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TASKGUI2.M with the given input arguments.
%
%      TASKGUI2('Property','Value',...) creates a new TASKGUI2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TaskGui2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TaskGui2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help TaskGui2

% Last Modified by GUIDE v2.5 30-Sep-2013 10:35:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TaskGui2_OpeningFcn, ...
                   'gui_OutputFcn',  @TaskGui2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TaskGui2 is made visible.
function TaskGui2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to TaskGui2 (see VARARGIN)

% Choose default command line output for TaskGui2
...
function varargout = TaskGui2_OutputFcn(hObject, eventdata, handles) 
...
while exist(strcat(handles.outputPath,handles.A.outputFile,'.mat'),'file')
    i = i+1; suf = num2str(i);
    handles.A.outputFile = strcat(pre,'_',dmy,'_',sub,'_',suf);
end
