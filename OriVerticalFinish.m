...
D.numR7 = sum(D.angle == 173);      % Total number of R7
D.numL7 = sum(D.angle == 7);       % Total number of L7
...
set(gca(1),'XTickLabel', {'All' 'L45' 'R45' 'L30' 'R30' 'L20' 'R20' 'L15' 'R15' 'L10' 'R10' 'L7' 'R7' 'L4' 'R4'}); %Then labels the three bars.
%Y AXIS
