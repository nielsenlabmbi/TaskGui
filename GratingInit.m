function A = GratingInit(S,A)

% function A = formseg_init(S,A)
%
...
% SHOULD NOT NEED AN OVERLAY WINDOW FOR THIS PROTOCOL
...
[A.window A.screenRect] = PsychImaging('OpenWindow',S.screenNumber,127);
...
% SHOULD NOT NEED ANY OF THIS BECAUSE NOT USING THE DATAPIXX 2 CLUT SYSTEM
