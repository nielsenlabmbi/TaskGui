...
L = 40;
V = 4;
A.dotSize = 64; % NOTE THAT 64 IS THE MAXIMUM VALUE ALLOWED FOR DRAWDOTS!!
frames = round(120*P.durStim);
...
[x(:,1) y(:,1) sig(:,1) d(:,1) l(:,1)] = genDots(N,R,A.dir,A.coh,L);
...
if L > 0; l = ceil(L*rand(N,1)); else l = zeros(N,1); end
