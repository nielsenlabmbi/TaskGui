...
S.runFunc = 'FaceRun';
% "finish trial" m-file
S.endFunc = 'FaceFinish';

% Define Banner text to identify the experimental protocol
S.protocolTitle = 'Face Discrimination Protocol';
...
% Stimulus settings
S.faceType = [1 2];
S.faceID = {'0-8';'2-7'};             % IDs for the different stimuli
S.basename = '/Users/nielsenlab/Documents/images/Image';                 % path and basename for stimuli
P.stimSize = 12;                          % stimulus size in deg
S.stimSize = 'Stimulus size (deg):';
...
P.durValve3 = 70;                                           % Reward duration for valve 3 (ms)
