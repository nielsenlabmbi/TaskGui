...
S.background = [0.25 0.25 0.25].^(1/2.2); % 2.2 GAMMA CORRECTION NEEDED FOR THE OVERLAY WINDOW
...
% Timing variables
P.durValve1 = 240;                                       % Reward duration for valve 1 (ms)
S.durValve1 = 'Duration of right valve (ms):';
P.durValve2 = 240;                                       % Reward duration for valve 2 (ms)
