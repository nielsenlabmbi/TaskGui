...
% Switch all 5 LED pins to the RESPONSEPixx to out direction
Datapixx('SetDinDataDirection', hex2dec('1F0000'));
% Setup the Digital Input Log, uses default values for the buffer address
Datapixx('SetDinLog');
% Start the Digital Input Log
Datapixx('StartDinLog');
% 30 ms refractory period on logging Din transitions, so that a button
% press results in a single Din transition
