...
bar(2,D.pcRight,'FaceColor',[0 0 1]);   %plots percentage of right data correct   
bar(3,D.pcLeft,'FaceColor',[1 0 0]);    %plots percentage of left data correct
%AXIS SETTIGNS
...
set(gca(1),'XTickLabel', {'All Trials' 'Right Trials' 'Left Trials'}); %Then labels the three bars.
%Y AXIS
...
y1=[rndPercentLR rndPercentR rndPercentL]; %Used as the percentage text being displayed on graph
...
y2=[rndTotalLR rndTotalR rndTotalL]; %Used as the total text being displayed on graph \
...
m=[1 2 3;1 2 3]; %the xaxis for the lines
