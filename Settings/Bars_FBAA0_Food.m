function [A S P] = Bars_FBAA0_Food
...
S.initFunc = 'BarsInitFood';
% "next trial" m-file
S.nextFunc = 'BarsNext';
% "run trial" m-file
S.runFunc = 'BarsRunFood';
% "finish trial" m-file
...
P.lineColor = 255;                                      % color value for non-form line segments
...
% Timing variables
P.durValve1 = 80;                                       % Reward duration for valve 1 (ms)
S.durValve1 = 'Duration of right valve (ms):';
P.durValve2 = 80;                                       % Reward duration for valve 2 (ms)
...
P.durTimeOut = 0;                                       % time out if not on first try
...
% Column 3: Distracter orientations
S.trialsList = [
1   8   90;
2   8   90;
1   8   90;
